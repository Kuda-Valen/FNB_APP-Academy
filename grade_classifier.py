...
def get_student_info():
    ...
    subject1_marks = float(input("Enter Subject 1 Marks: "))
    subject2 = input("Enter Subject 2 Name: ").strip()
    subject2_marks = float(input("Enter Subject 2 Marks: "))
    subject3 = input("Enter Subject 3 Name: ").strip()
    subject3_marks = float(input("enter Subject 3 Marks: "))
    ...
    student = (name, subjects, subject_marks, grade_letter, pass_status)
    print("\n=== Student Info ===\n")
    print(f"Student Name: {student[0].title()}")
    print("Subjects:")
    i = 0
    while i < 3:
        print(f"Subject: {subjects[i]} : {subject_marks[i]} marks")
        i += 1
